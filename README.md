# Color Combine
[![Marketplace installs](https://img.shields.io/visual-studio-marketplace/i/Aritz-Garciaa.color-combinee?logo=visualstudiocode&logoColor=%23007ACC)](https://marketplace.visualstudio.com/items?itemName=Aritz-Garciaa.color-combinee)
[![Marketplace rating](https://img.shields.io/visual-studio-marketplace/stars/Aritz-Garciaa.color-combinee?logo=visualstudiocode&logoColor=%23007ACC)](https://marketplace.visualstudio.com/items?itemName=Aritz-Garciaa.color-combinee)
...
- From the Marketplace link: [Color Combine](https://marketplace.visualstudio.com/items?itemName=Aritz-Garciaa.color-combinee).
